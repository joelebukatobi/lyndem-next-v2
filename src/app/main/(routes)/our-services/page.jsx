        ...
        <div className="services-section">
          ...
          <div className="row">
            ...
            <div className="services-section-text">
              <p>
                The Educational Games Cafe offers children a space to engage with board, card, and electronic
                educational games while connecting with like-minded peers. Guided by facilitators, activities are
                tailored to each child’s interests and intellectual abilities.
              </p>
          ...
          <div className="row">
            ...
            <div className="services-section-text">
              <p>
                ...
                specific skills and concepts. Unlike unstructured play, this approach uses games as powerful tools to
                make learning enjoyable, engaging, and effective. By transforming traditional lessons into dynamic
                experiences, children retain knowledge better and develop critical thinking skills. At the heart of Game
                Schooling is the belief that kids learn best when they enjoy the process. Games provide an interactive
                and stimulating environment where children can explore, collaborate, and solve problems in a way that
